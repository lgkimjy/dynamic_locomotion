...
mjModel* LoadModel(const char* file, mj::Simulate& sim) {
  ...
  /////////////////////////// USER CODE : START ///////////////////////////
	if (strstr(filename, ".xml") != nullptr) {
		robot_control.InitializeSystem(mnew);
	}
	//////////////////////////// USER CODE : END ////////////////////////////
...

    {
      ...
      if (m) {
        ...
        if (sim.run) {
          ...
          double slowdown = 150 / sim.percentRealTime[sim.real_time_index];
...
#elif defined(ROBOT6)
	const char* filename = "../model/MAHRU-WL/MAHRU-WL.xml";
#elif defined(ROBOT7)
